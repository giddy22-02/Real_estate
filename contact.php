...
<body>
	...
	<div id="page-wrapper">
		<div class="row">
								...
								<ul>
									<li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
										<div class="contact-address">
											...
											<span class="text-white">2906-00100 Nairobi, Kenya</span> <br>
											<span class="text-white">Mbagathi Way, Riara University </span>
										</div>
									</li>
									<li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
										<div class="contact-address">
											<h5 class="text-white">Call Us</h5>
											<span class="d-table text-white">+254-791-668-451</span>
											<span class="text-white">+254 743-765-431 </span>
										</div>
									</li>
									<li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
										<div class="contact-address">
											<h5 class="text-white">Email Adderss</h5>
											<span class="d-table text-white">helpline@ikranhomes.ac.ke</span>
											<span class="text-white">helpline@ikranhomes.ac.ke</span>
										</div>
									</li>
								</ul>
							</div>
			...
			<!--	Map -->
			<iframe src="https://maps.google.com/maps?q=%20P.O.%20Box%2049940%20%E2%80%93%2000100,&t=&z=13&ie=UTF8&iwloc=&output=embed" width="100%" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
			<!--	Map -->
